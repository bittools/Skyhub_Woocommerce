...
return array(
    ...
    'price'                => array(
        ...
        'wordpress' => '_price',
        'mapper'    => array(
            'post_to_entity' => \B2W\SkyHub\Model\Transformer\Product\Price\PostToEntity::class
        )
    ),
    ...
    'categories'           => array(
        'skyhub'        => 'categories',
        'mapper'        => array(
            'post_to_entity' => \B2W\SkyHub\Model\Transformer\Category\PostToEntity::class,
    ...
    'specifications'       => array(
        ...
        'mapper'        => array(
            'post_to_entity' => \B2W\SkyHub\Model\Transformer\Product\Specification\PostToEntity::class,
    ...
    'variations'           => array(
        'skyhub'        => 'variations',
        'mapper'        => array(
            'post_to_entity' => \B2W\SkyHub\Model\Transformer\Product\Variation\Collection\PostToEntity::class,
    ...
    'variation_attributes' => array(
        ...
        'mapper'        => array(
            'post_to_entity' => \B2W\SkyHub\Model\Transformer\Product\VariationAttributes\PostToEntity::class,
