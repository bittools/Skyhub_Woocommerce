...
use B2W\SkyHub\Model\Resource\Sales\Order\Collection;
 ...
 */
class Db extends RepositoryAbstract implements \B2W\SkyHub\Contracts\Resource\Sales\Order\Repository\Db
{
    ...
    /**
     * @param $post
     * @return \B2W\SkyHub\Model\Sales\Order\Entity|mixed|null
     * @throws \Exception
     */
    public function one($post)
    {
        ...
        $order = new \B2W\SkyHub\Model\Sales\Order\Entity();
    ...
    public function save(Entity $order)
    {
        ...
        $validation = new \B2W\SkyHub\Model\Validation\Sales\Order\Entity();
        ...
        if ($isNew) {
            try {
                /** @var \B2W\SkyHub\Model\Sales\Order\Item\Entity $item */
